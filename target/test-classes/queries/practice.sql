...
-- US03-CK
    ...
    SELECT distinct name from book_categories;

-- US04-CK

    SELECT b.name,b.isbn,b.year,b.author,bc.name,b.description  FROM books b
...
select name from books where name like 'Head First Java';
select name from books where name like 'The Scrum Field Guide';

-- US07-CK

select *from books;
select * from book_borrow ;
select * from users where full_name like('Test Student 5');
